...
public class SkuController {
    ...
    @RequestMapping("/querySkuStock")
    public SkuStockRes querySkuStock(WebContext webContext, @RequestParam("productId") String productId) {
        return bizSkuService.querySkuStock(productId);
    }
}
